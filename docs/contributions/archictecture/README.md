...
1. Open an issue in Github using this  [link](https://github.com/mustafkamal/sketchup-structureline/issues/new?template=contributions-in-architecture.md). Type the title, describe your idea, and click **Create**.
